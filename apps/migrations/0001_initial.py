# Generated by Django 5.0.6 on 2025-09-15 16:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat_in', models.DecimalField(decimal_places=7, max_digits=10, null=True)),
                ('long_in', models.DecimalField(decimal_places=7, max_digits=10, null=True)),
                ('lat_out', models.DecimalField(decimal_places=7, max_digits=10, null=True)),
                ('long_out', models.DecimalField(decimal_places=7, max_digits=10, null=True)),
                ('photo_in', models.ImageField(null=True, upload_to='attendance/')),
                ('photo_out', models.ImageField(null=True, upload_to='attendance/')),
